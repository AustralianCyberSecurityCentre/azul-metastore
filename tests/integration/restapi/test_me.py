        ...
        self.assertEqual(
            resp,
            {
                ...
                "security": {
                    ...
                    "max_access": "TOP HIGH MOD1 MOD2 MOD3 HANOVERLAP OVER REL:APPLE",
                    "max_access_display": "TOP HIGH MOD1 MOD2 MOD3 HANOVERLAP OVER REL:APPLEO",
        ...
        self.assertEqual(
            resp,
            {
                ...
                "security": {
                    ...
                    "max_access_display": "LOW TLP:AMBER+STRICT",
                    "allowed_presets": ["LOW"],
                },
            },
        )
        ...
        self.assertEqual(
            resp,
            {
                ...
                "security": {
                    ...
                    "max_access_display": "MEDIUM REL:APPLEO",
        ...
        self.assertEqual(
            resp,
            {
                ...
                "security": {
                    ...
                    "max_access_display": "HIGH MOD1 REL:APPLE,BEE",
                    "allowed_presets": ["LOW", "MEDIUM", "HIGH", "MEDIUM REL:APPLE,BEE", "MEDIUM REL:APPLE"],
                },
            },
        )
